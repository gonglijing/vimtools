...
"
"             Command: "EnQucikSnippet" - Start source snippet (a better way to use ctags)
...
hi CCVEXT_MarkWord  ctermbg=Cyan    ctermfg=Black  guibg=#8CCBEA    guifg=Black
"}}}
"
...
function! EnQuickSnippet ()
    ...
    :map <C-]> : call TagTrace (expand('<cfile>')) <CR>
...
function! SourceSnippet()
    ...
    normal zt
    redraw
    exe "windo syntax clear CCVEXT_MarkWord"
    exe "syntax match CCVEXT_MarkWord" . " '" . escape (s:current_tag, "~") . "' " . "containedin=.*"
...
"Command setting {{{
if !exists(':EnQucikSnippet')
	command! -nargs=0 EnQucikSnippet :call EnQuickSnippet ()
endif
...
"Menu setting {{{
amenu CCVimExt.CreateCCDatabase    :call SyncSymbs   () <CR>
amenu CCVimExt.ListCCDatabase      :call ConfigSymbs () <CR>

menu  CCVimExt.-Sep0-	           :
amenu CCVimExt.EnableQuickSnippet  :call EnQuickSnippet () <CR>
amenu CCVimExt.DisableQuickSnippet :call DiQuickSnippet () <CR>

menu  CCVimExt.-Sep1-	           :
amenu CCVimExt.FindCalling         :cs find c <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindCalled          :cs find d <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindEgrep           :cs find e <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindThisFile        :cs find f <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindThisDef         :cs find g <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindFileIncThisFile :cs find i <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindSymbs           :cs find s <C-R>=expand("<cword>")<CR><CR>
amenu CCVimExt.FindAssignmentsTo   :cs find t <C-R>=expand("<cword>")<CR><CR>

menu  CCVimExt.-Sep100-	           :
amenu CCVimExt.FunctionList        :call CallPluginTagList () <CR>
amenu CCVimExt.RecentFiles         :call CallPluginMRU () <CR>
